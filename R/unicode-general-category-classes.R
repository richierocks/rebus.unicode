...
{
  repeated("\\p{LC}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Pe}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Pc}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Cc}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Sc}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Pd}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Nd}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Me}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Pf}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Cf}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Pi}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{L}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Nl}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Zl}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Ll}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{M}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Sm}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Lm}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Sk}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Mn}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{N}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Ps}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{O}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Lo}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{No}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Po}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{So}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Zp}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Co}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{P}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Z}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Zs}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Mc}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Cs}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{S}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Lt}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{Cn}", lo, hi, char_class = TRUE)
}
...
{
  repeated("\\p{ALPHABETIC}", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:ASCII_HEX_DIGIT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:BIDI_CONTROL:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:BIDI_MIRRORED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CASE_IGNORABLE:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CASE_SENSITIVE:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CASED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_CASEFOLDED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_CASEMAPPED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_LOWERCASED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_NFKC_CASEFOLDED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_TITLECASED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:CHANGES_WHEN_UPPERCASED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:DASH:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:DEFAULT_IGNORABLE_CODE_POINT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:DEPRECATED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:DIACRITIC:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:EXTENDER:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:HEX_DIGIT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:HYPHEN:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:ID_CONTINUE:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:ID_START:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:IDEOGRAPHIC:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:LOWERCASE:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:MATH:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:NONCHARACTER_CODE_POINT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:POSIX_ALNUM:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:POSIX_BLANK:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:POSIX_GRAPH:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:POSIX_PRINT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:POSIX_XDIGIT:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:QUOTATION_MARK:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:SOFT_DOTTED:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:TERMINAL_PUNCTUATION:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:UPPERCASE:]", lo, hi, char_class = TRUE)
}
...
{
  repeated("[:WHITE_SPACE:]", lo, hi, char_class = TRUE)
}
